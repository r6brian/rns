...
# Database: rns
# Generation Time: 2016-02-21 12:42:46 +0000
# ************************************************************
...
VALUES
	...
	(144,'Volvo Model Replicas, Co','Berglund','Christina ','0921-12 3555','Berguvsv_gen  8',NULL,'Lule¶',NULL,'S-958 22','Sweden',1504,53100),
	(145,'Danish Wholesale Imports','Petersen','Jytte ','31 12 3555','VinbÒltet 34',NULL,'Kobenhavn',NULL,'1734','Denmark',1401,83400),
	...
	(169,'Porto Imports Co.','de Castro','Isabel ','(1) 356-5555','Estrada da sa_de n. 58',NULL,'Lisboa',NULL,'1756','Portugal',NULL,0),
	(171,'Daedalus Designs Imports','RancÔ','Martine ','20.16.1555','184, chaussÔe de Tournai',NULL,'Lille',NULL,'59000','France',1370,82900),
	...
	(209,'Mini Caravy','Citeaux','FrÔdÔrique ','88.60.1555','24, place KlÔber',NULL,'Strasbourg',NULL,'67000','France',1370,53800),
	...
	(216,'Enaco Distributors','Saavedra','Eduardo ','(93) 203 4555','Rambla de Cataluãa, 23',NULL,'Barcelona',NULL,'8022','Spain',1702,60300),
	(219,'Boards & Toys Co.','Young','Mary','3105552373','4097 Douglas Av.',NULL,'Glendale','CA','92561','USA',1166,11000),
	(223,'Nat÷rlich Autos','Kloss','Horst ','0372-555188','Taucherstra_e 10',NULL,'Cunewalde',NULL,'1307','Germany',NULL,0),
	(227,'Heintze Collectables','Ibsen','Palle','86 21 3555','Smagsloget 45',NULL,'_rhus',NULL,'8200','Denmark',1401,120800),
	(233,'QuÔbec Home Shopping Network','FresniÓre','Jean ','(514) 555-8054','43 rue St. Laurent',NULL,'MontrÔal','QuÔbec','H1J 1C3','Canada',1286,48700),
	(237,'ANG Resellers','Camino','Alejandra ','(91) 745 6555','Gran VÞa, 1',NULL,'Madrid',NULL,'28001','Spain',NULL,0),
	...
	(256,'Auto AssociÔs & Cie.','Tonini','Daniel ','30.59.8555','67, avenue de l\'Europe',NULL,'Versailles',NULL,'78000','France',1370,77900),
	(259,'Toms Spezialit_ten, Ltd','Pfalzheim','Henriette ','0221-5554327','Mehrheimerstr. 369',NULL,'K_ln',NULL,'50739','Germany',1504,120400),
	...
	(298,'Vida Sport, Ltd','Holz','Mihael','0897-034555','Grenzacherweg 237',NULL,'GenÓve',NULL,'1203','Switzerland',1702,141300),
	...
	(335,'Cramer Spezialit_ten, Ltd','Cramer','Philip ','0555-09555','Maubelstr. 90',NULL,'Brandenburg',NULL,'14776','Germany',NULL,0),
	...
	(356,'SAR Distributors, Co','Kuger','Armand','+27 21 550 3555','1250 Pretorius Street',NULL,'Hatfield','Pretoria','28','South Africa',NULL,0),
	...
	(443,'Feuer Online Stores, Inc','Feuer','Alexander ','0342-555176','Heerstr. 22',NULL,'Leipzig',NULL,'4179','Germany',NULL,0),
	(447,'Gift Ideas Corp.','Lewis','Dan','2035554407','2440 Pompton St.',NULL,'Glendale','CT','97561','USA',1323,49700),
	(448,'Scandinavian Gift Ideas','Larsson','Martha','0695-34 6555','_kergatan 24',NULL,'Br_cke',NULL,'S-844 67','Sweden',1504,116400),
	...
	(458,'Corrida Auto Replicas, Ltd','Sommer','MartÞn ','(91) 555 22 82','C/ Araquil, 67',NULL,'Madrid',NULL,'28023','Spain',1702,104600),
	...
	(484,'Iberia Gift Imports, Corp.','Roel','JosÔ Pedro ','(95) 555 82 82','C/ Romero, 33',NULL,'Sevilla',NULL,'41101','Spain',1702,65700),
